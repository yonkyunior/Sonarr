...
namespace NzbDrone.Api.Series
{
...

    {
            ...
            : base(signalRBroadcaster)
        {
            ...
            SharedValidator.RuleFor(s => s.LanguageProfileId).SetValidator(languageProfileExistsValidator).When(s => s.LanguageProfileId != 0);
            ...
            // Ensure any editing has a valid LanguageProfileId
            PutValidator.RuleFor(s => s.LanguageProfileId).NotEqual(0);
        }
        ...
        private int AddSeries(SeriesResource seriesResource)
        {
            ...
            // Set a default LanguageProfileId to maintain backwards compatability with apps using the v2 API
            if (model.LanguageProfileId == 0)
            {
