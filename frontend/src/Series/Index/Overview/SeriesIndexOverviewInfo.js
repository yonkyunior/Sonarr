...
function SeriesIndexOverviewInfo(props) {
  ...
  return (
    <div className={styles.infos}>
      ...
      {
        isVisible('network', showNetwork, network, sortKey) && maxRows > 2 &&
          <div
            className={styles.info}
            title="Network"
          >
      ...
      {
        isVisible('qualityProfileId', showQualityProfile, qualityProfile, sortKey) && maxRows > 3 &&
          <div
            className={styles.info}
      ...
      {
        isVisible('previousAiring', showPreviousAiring, previousAiring, sortKey) && maxRows > 4 &&
          <div
            className={styles.info}
      ...
      {
        isVisible('added', showAdded, added, sortKey) && maxRows > 5 &&
          <div
            className={styles.info}
            title="Date Added"
          >
      ...
      {
        isVisible('seasonCount', showSeasonCount, seasonCount, sortKey) && maxRows > 6 &&
          <div
            className={styles.info}
            title="Season Count"
          >
      ...
      {
        isVisible('path', showPath, path, sortKey) && maxRows > 7 &&
          <div
            className={styles.info}
            title="Path"
          >
      ...
      {
        isVisible('sizeOnDisk', showSizeOnDisk, sizeOnDisk, sortKey) && maxRows > 8 &&
          <div
            className={styles.info}
            title="Size on Disk"
          >
